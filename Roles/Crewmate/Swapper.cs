...
public static class Swapper
{
    ...
    public static string GetSwappermax(byte playerId) => string.Empty; //Utils.ColorString((Swappermax.TryGetValue(playerId, out var x) && x >= 1) ? Utils.ColorString(Utils.GetRoleColor(CustomRoles.Swapper).ShadeColor(0.25f) : Color.gray, Swappermax.TryGetValue(playerId, out var changermax) ? $"({changermax})" : "Invalid");
